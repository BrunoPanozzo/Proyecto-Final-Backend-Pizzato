...
class ProductsRouter extends Router {
    init() {        
        ...
        this.put('/:pid', userIsLoggedIn, userIsAdminOrPremium, validarProdActualizado, withController((controller, req, res) => controller.updateProduct(req, res)))

        this.delete('/:pid', userIsLoggedIn, userIsAdminOrPremium, validarProductoExistente, withController((controller, req, res) => controller.deleteProduct(req, res)))  
